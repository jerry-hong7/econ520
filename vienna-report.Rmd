...
Below is a table showing the average price and customer rating by accommodation type.
...
```{r price-rating-plot, echo=FALSE}
vienna %>%
...
```{r price-rating-hist, echo=FALSE}
